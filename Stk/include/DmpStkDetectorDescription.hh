...
public:
  ...
  DmpStkDetectorDescription(G4GDMLParser* gdmlParser, TXMLEngine* engine, XMLNodePointer_t pointer);
...
public:
  ...
  */
  ...
  G4bool isVolumeSTKStrip(const G4String& volumename);


  //G4int    GetPlaneNumber(G4LogicalVolume* tilen);
  void GetSensitiveDetectorParamters(G4LogicalVolume* tile,
                                       G4int& PlaneNumber,
                                       G4int& BlockNumber,
                                       G4int& LadderNumber,
                                       G4int& IsX,
  ...
  G4int  IsFloatingStrip(G4int isX, G4int NStrip);
...
private:
  ...
  XMLNodePointer_t   xmlSTKnodepointer;
  ...
  G4int STKnStripsPerLadder;
  G4int STKnLaddersPerBlock;
...
private:
  ...
  void getStkParametersFromGDMLandXML();
  ...
  G4int    __GetPlaneNumber(G4LogicalVolume* tile);
  G4int    __GetTileNumber(G4LogicalVolume* tile);
