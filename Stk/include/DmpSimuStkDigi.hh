...
public:
  ...
  #ifdef DAMPESW_DEBUG
  inline void SetDigitX(G4double x)   { digitx = x;  };
  inline void SetDigitY(G4double y)   { digity = y;  };
  inline void SetDigitZ(G4double z)   { digitz = z;  };
  #endif
  ...
  #ifdef DAMPESW_DEBUG
  inline G4double GetDigitX()       { return digitx;  };
  inline G4double GetDigitY()       { return digity;  };
  inline G4double GetDigitZ()       { return digitz;  };
  #endif
