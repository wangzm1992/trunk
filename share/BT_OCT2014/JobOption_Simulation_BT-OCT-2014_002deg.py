...
SimAlg.Set("GeometryMainGdmlName","DAMPE_BT_OCTOBER2014_002deg.gdml")
SimAlg.Set("MacFile", os.environ['DMPSWSYS'] + "/share/TestRelease/BT_OCT2014/electron_002deg.mac")
